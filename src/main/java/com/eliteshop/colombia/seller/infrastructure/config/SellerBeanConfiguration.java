...
public class SellerBeanConfiguration {
    ...
    @Bean
    public SellerFindBankInfoBySellerIdUseCase sellerFindBankInfoBySellerIdUseCase(SellerFindByIdUseCase sellerFindByIdUseCase) {
        return new SellerFindBankInfoBySellerIdUseCase(sellerFindByIdUseCase);
    }

    @Bean
    public SellerFindContactBySellerIdUseCase sellerFindContactBySellerIdUseCase(SellerFindByIdUseCase sellerFindByIdUseCase) {
